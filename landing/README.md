...
The download buttons point directly to the next published `v0.2.9` ZIP asset:

`https://github.com/trashdb/statefalse/releases/download/v0.2.9/Statefalse-v0.2.9.zip`
