...
The download buttons point directly to the next published `v0.2.11` ZIP asset:

`https://github.com/trashdb/statefalse/releases/download/v0.2.11/Statefalse-v0.2.11.zip`
