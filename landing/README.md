...
The download buttons point directly to the next published `v0.2.14` ZIP asset:

`https://github.com/trashdb/statefalse/releases/download/v0.2.14/Statefalse-v0.2.14.zip`
