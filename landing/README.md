...
The download buttons currently point directly to the confirmed `v0.2.5` ZIP asset:

`https://github.com/trashdb/statefalse/releases/download/v0.2.5/Statefalse-v0.2.5.zip`
